...
// Uses 16x16 tiles for efficient memory access patterns
// Significantly faster than naive O(K) per-thread approach
...
void main() {
    uint row = gl_GlobalInvocationID.x; // Row of C
    uint col = gl_GlobalInvocationID.y; // Column of C
